...
- **Secondary Actors:** Система обробки фінансових даних  
...
3. **Система перевіряє структуру файлу** – визначає заголовки, формат дат, стовпці транзакцій.  
4. **Система обробляє дані** – розпізнає транзакції та категоризує їх.  
5. **Система відображає список імпортованих транзакцій** – користувач бачить коректно розпізнані дані.  
6. **Користувач підтверджує імпорт** – транзакції зберігаються у внутрішній системі.  
7. **Користувач може переглядати та редагувати імпортовані транзакції**.  
